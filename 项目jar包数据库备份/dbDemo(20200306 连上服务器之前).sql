...
-- ----------------------------
BEGIN;
INSERT INTO `food` VALUES (31, '脆皮鸡饭', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (32, '脆皮鸡饭', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (42, '羊肉水饺', 0, NULL, 0, NULL, 14, NULL, NULL, NULL);
INSERT INTO `food` VALUES (44, '意大利面', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (45, '羊肉水饺', 0, NULL, 0, NULL, 14, NULL, NULL, NULL);
INSERT INTO `food` VALUES (46, '脆皮鸡饭', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (47, '脆皮鸡饭', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (48, '脆皮鸡饭', 0, NULL, 0, NULL, 0, NULL, NULL, NULL);
INSERT INTO `food` VALUES (49, '牛肉水饺', 0, NULL, 0, NULL, 14, NULL, NULL, NULL);
INSERT INTO `food` VALUES (50, '牛肉水饺', 0, NULL, 0, NULL, 14, NULL, NULL, NULL);
INSERT INTO `food` VALUES (51, '比萨', 1, 'this is pizza', 6, 'qwerty', 20, NULL, '西餐', '1');
COMMIT;
...
CREATE TABLE `sys_food_label` (
  ...
  CONSTRAINT `FKkl96lcmltdywje1pjlh48krgr` FOREIGN KEY (`label_id`) REFERENCES `food` (`food_id`),
  CONSTRAINT `FKt1hasrx4amqwad4mx3gni0wwr` FOREIGN KEY (`food_id`) REFERENCES `label` (`label_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
